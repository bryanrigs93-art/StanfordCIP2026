...
This program is an extra Coding With AI practice project.

It uses a small ice cream sales dataset to demonstrate the basic machine
learning workflow:

1. Load data from a CSV file
2. Select features and a target value
3. Split the data into training and testing sets
4. Train a Linear Regression model
5. Evaluate the model
6. Make a simple sales prediction
